       ...
       <div class="collapse navbar-collapse" id="navbarResponsive">
         ...
         <form class="form-inline" action="<?php echo "irchhjklmres.php"; ?>" method="post">
            <div ng-controller="myCtrl" ng-init="loadCountry()">
              <input  class="form-control mr-2" type="text" name="rcle" placeholder="Search" autocomplete="off"  ng-model="country" ng-keyup="complete(country)"  value="" style="width:380px;padding-left:8px;">
         ...
         <ul class="navbar-nav ml-auto">
           ...
           <li class="dropdown">
             ...
             <div class="dropdown-menu" href="#">
                <a class="dropdown-item" href=""><i class="fas fa-user-circle"></i> <?php echo htmlspecialchars($user); ?> </a>
                 <a class="dropdown-item" href=""><i class="fab fa-telegram-plane"></i>  Habiba</a>
